...
const Register = () => {
  ...
  return (
    <div className="h-screen w-screen bg-main flex flex-col  items-center overflow-auto">
      <div className="flex text-white flex-col gap-[2rem] items-center py-5 h-2/3 w-auto md:w-1/3">
        <div className="relative py-3  sm:w-full min-w-[300px] md:w-5/6 ">
          <div className="relative px-4 py-10 bg-card mx-8 md:mx-0 shadow rounded-3xl ">
